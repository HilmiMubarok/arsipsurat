...
if (isset($_POST['button'])) {
    ...
    if (upload()) {
        $save = $obj->insert('surat_keluar', $data);

        if ($save) {
            showAlert('success', 'Data Berhasil Disimpan', 'pages.php?p=surat-keluar');
        } else {
            showAlert('error', $save, 'pages.php?p=tambah-surat-keluar');
        }
    }
                                ...
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nomor_surat" class="form-control" readonly  value="<?= getNomorSurat("surat_keluar") ?>">
                                        </div>
                                        <div class="form-group">
