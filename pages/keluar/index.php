...
$obj     = new DynamicCrud();
$results = $obj->fetchall('surat_keluar',array('id_surat_keluar','nomor_surat','tanggal_keluar', 'pengirim', 'kepada', 'perihal','tanggal_entry', 'file'));
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <?php if ($_SESSION['user']['level'] == "admin"): ?>
                                        ...
                                        <a href="<?= BASE_URL . "/pages.php?p=tambah-surat-keluar" ?>" class="mb-3 btn btn-primary">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($_SESSION['user']['level'] == "admin"): ?>
                                                            ...
                                                            <a href="<?= BASE_URL. "/pages.php?p=edit-surat-keluar&id=".$data['id_surat_keluar'] ?>" class="btn btn-sm btn-warning">
                                                                <i class="feather icon-edit"></i> Edit
                                                            </a>
                                                            <a href="<?= BASE_URL. "/pages.php?p=hapus-surat-keluar&id=".$data['id_surat_keluar'] ?>" class="btn btn-sm btn-danger">
