...
if (isset($_POST['button'])) {
    ...
    if (!empty($_FILES['file']['name'])) {
        ...
        if (upload()) {
            ...
            $update = $obj->update("surat_masuk", $data, $id);
            if ($update) {
                showAlert('success', 'Data Berhasil Diubah', 'pages.php?p=surat-masuk');
            } else {
                showAlert('error', $update, "pages.php?p=edit-surat-masuk&id=$_GET[id]");
            }
        }
    } else {
        $data = [
            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        ...
                        <span>Edit Surat Masuk <?= $data->nomor_surat ?></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Edit Surat Masuk <?= $data->nomor_surat ?></h5>
                                </div>
                                <div class="card-body">
