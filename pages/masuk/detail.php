<?php $data = getWhere('surat_masuk', 'id_surat_masuk', $_GET['id']); ?>
            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        ...
                        <span>Detail Surat Masuk <?= $data->nomor_surat ?></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <a href="<?= BASE_URL. "/pages.php?p=surat-masuk" ?>" class="btn btn-primary">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
